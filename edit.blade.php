            ...
            <form action="{{route('create-property')}}" method="post" class="p-6 bg-white border-b border-gray-200"> @csrf
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                            ...
                            <input class=" civanogly-input" type="text" id="name" name="name" value="{{$property->name}} " >
                            @error('name')
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <input class=" civanogly-input" type="text" id="name_tr" name="name_tr" value="{{$property->name_tr}}" >
                    ...
                    <div class="flex -mx-4 mb-6">
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <input class=" civanogly-input" type="number" id="price" name="price" value="{{$property->price}}"  >
                            @error('price')
                            <p class="text-red-500 mt-2 text-sm"> {{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="flex -mx-4 mb-6">
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <input class=" civanogly-input" type="number" id="gross_sqm" name="gross_sqm" value="{{$property->gross_sqm}}">
 >
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                           ...
                           <textarea class=" civanogly-input" name="overview" id="overview" cols="50" rows="3"   > {{$property->overview}} </textarea>
                            @error('overview')
                            <p class="text-red-500 mt-2 text-sm"> {{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex-1 px-4">
                           ...
                           <textarea class=" civanogly-input" name="overview_tr" id="overview_tr" cols="50" rows="3" > {{$property->overview_tr}}</textarea>
                            @error('overview_tr')
                            <p class="text-red-500 mt-2 text-sm"> {{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                           ...
                           <textarea class=" civanogly-input" name="why_buy" id="why_buy" cols="50" rows="4"  > {{$property->why_buy}} </textarea>
                            @error('why_buy')
                            <p class="text-red-500 mt-2 text-sm"> {{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex-1 px-4">
                           ...
                           <textarea class=" civanogly-input" name="why_buy_tr" id="why_buy_tr" cols="50" rows="4" > {{$property->why_buy_tr}} </textarea>
                            @error('why_buy_tr')
                            <p class="text-red-500 mt-2 text-sm"> {{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="flex -mx-4 mb-6">
                        ...
                        <div class="flex-1 px-4">
                           ...
                           <textarea class=" civanogly-input" name="description_tr" id="description_tr" cols="50" rows="5" >{{$property->description_tr}}</textarea>
