                         ...
                         @foreach($properties as $property)
                          <tr>
                              ...
                              <td class="border px-4 py-2">
                                   <a class="bg-blue-500 text-white px-4 py-2 text-sm rounded" href="">Edit</a>
                                   <a class="bg-green-500 text-white px-4 py-2 text-sm rounded" href="">View</a> 
                                   <a class="bg-red-500 text-white px-4 py-2 text-sm rounded" href="">Delete</a> 
