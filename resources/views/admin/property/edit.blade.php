            ...
            <form action="{{route('create-property')}}" method="post" class="p-6 bg-white border-b border-gray-200"> @csrf
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                            ...
                            <input class=" civanogly-input" type="text" id="name" name="name" value="{{$property->name}} " required >
                            @error('name')
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <input class=" civanogly-input" type="text" id="name_tr" name="name_tr" value="{{$property->name_tr}}" required>
                    ...
                    <div class="mb-6">
                        <label class=" civanogly-label"for="gallery_image">Gallery Image  <span class="required-text">*</span> </label>
                            <input class=" civanogly-input" type="file" id="gallery_image" name="gallery_image" >
                    ...
                    <div class="flex -mx-4 mb-6">
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <input class=" civanogly-input" type="number" id="price" name="price" value="{{$property->price}}" required >
                            @error('price')
                            <p class="text-red-500 mt-2 text-sm"> {{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex-1 px-4">
                            <label class=" civanogly-label"for="type"> Type  <span class="required-text">*</span> </label>
                            <select class=" civanogly-input" name="type" id="type" >
                                <option  value="">Select Type</option>
                                <option {{$property->type == '0' ? 'selected="selected"' : '' }} value="0"> Land </option>
                                <option {{$property->type == '0' ? 'selected="selected"' : '' }} value="1"> Apperment </option>
                                <option {{$property->type == '0' ? 'selected="selected"' : '' }} value="2"> Villa </option>
                    ...
                    <div class="flex -mx-4 mb-6">
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <select class=" civanogly-input" name="bedrooms" id="bedrooms" >
                                ...
                                <option {{$property->bedrooms == '2+1' ? 'selected="selected"' : '' }} value="2"> 2+1 </option>
                                <option {{$property->bedrooms == '3+1' ? 'selected="selected"' : '' }} value="2"> 3+1 </option>
                                <option {{$property->bedrooms == '4+1' ? 'selected="selected"' : '' }} value="2"> 4+1 </option>
                                <option {{$property->bedrooms == '5+2' ? 'selected="selected"' : '' }} value="2"> 5+2 </option>
                                <option {{$property->bedrooms == '4+2' ? 'selected="selected"' : '' }} value="2"> 4+2 </option>
                            </select>
                        ...
                        <div class="flex-1 px-4">
                            <label class=" civanogly-label"for="bathrooms"> Bathrooms  <span class="required-text">*</span></label>
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <input class=" civanogly-input" type="number" id="net_sqm" name="net_sqm" value="{{$property->net_sqm}}" >
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <input class=" civanogly-input" type="number" id="gross_sqm" name="gross_sqm" value="{{$property->gross_sqm}}" required>
 >
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <select class=" civanogly-input" name="pool" id="pool"  >
                                ...
                                <option {{$property->pool == '2' ? 'selected="selected"' : '' }} value="2"> Privet </option>
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                           ...
                           <textarea class=" civanogly-input" name="overview" id="overview" cols="50" rows="3"  required > {{$property->overview}} </textarea>
                            @error('overview')
                            <p class="text-red-500 mt-2 text-sm"> {{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex-1 px-4">
                           ...
                           <textarea class=" civanogly-input" name="overview_tr" id="overview_tr" cols="50" rows="3" required > {{$property->overview_tr}}</textarea>
                            @error('overview_tr')
                            <p class="text-red-500 mt-2 text-sm"> {{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                           ...
                           <textarea class=" civanogly-input" name="why_buy" id="why_buy" cols ="50" rows="4" required > {{$property->why_buy}} </textarea>
                            @error('why_buy')
                            <p class="text-red-500 mt-2 text-sm"> {{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex-1 px-4">
                           ...
                           <textarea class=" civanogly-input" name="why_buy_tr" id="why_buy_tr" cols="50" rows="4" required > {{$property->why_buy_tr}} </textarea>
                            @error('why_buy_tr')
                            <p class="text-red-500 mt-2 text-sm"> {{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                           ...
                           <textarea class=" civanogly-input" name="description" id="description" cols="50" rows="5" required>{{$property->description}}  </textarea>
                            @error('description')
                            <p class="text-red-500 mt-2 text-sm"> {{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex-1 px-4">
                           ...
                           <textarea class=" civanogly-input" name="description_tr" id="description_tr" cols="50" rows="5" required >{{$property->description_tr}}</textarea>
