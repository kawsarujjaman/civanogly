    ...
    <div class="md:flex mx-4">
        <div class="flex-1 px-4 mb-6">
            <div class="bg-white rounded-xl flex">
                ...
                <div class=" p-4">
                    <h3 class="font-bold mb-4 text-xl">Lorem ipsum dolor sit amet consectetur </h3>
                    <a class= "fullwidth-btn bg-gray-800 text-white px-6 py-2 rounded w-full inline-block text-center" href=""> More details </a>
                </div>
        ...
        <div class="flex-1 px-4">
            <div class="bg-white rounded-xl flex">
                <div style="min-width:130px" class=" "> 
                    <img style="width:130px" src="{!! asset('img/property2.jpeg') !!}" alt="">
                </div>
        ...
        <div class="flex-1 px-4">
            <div class="bg-white rounded-xl flex">
                <div style="min-width:130px" class=" "> 
                  <img style="width:130px" src="{!! asset('img/property3.jpeg') !!}" alt="">
                 </div>
                <div class=" p-4">
                    <h3 class="font-bold mb-4 text-xl">Lorem ipsum dolor sit amet consectetur </h3>
                    <a class= "fullwidth-btn bg-gray-800 text-white px-6 py-2 rounded w-full inline-block text-center" href=""> More details </a>
           ...
           <div class="flex mx-0 md:-mx-6 font-bold">
               <div class="flex-1 px-4 md:px-6">
                   <ul class="justify-centre">
                       ...
                       <li class=" " > <a href="">For Developers</a> </li>
                   </ul>
               </div>
               ...
               <div class="flex-1 px-4 md:px-6">
                   <ul class="justify-centre">
                       ...
                       <li class=" " > <a href=""> Smart Search</a> </li>
                   </ul>
               </div>
               ...
               <div class="flex-1 px-4 md:px-6">
                   <ul class="justify-centre">
                       ...
                       <li class=" " > <a href=""> Primary policy</a> </li>
                   </ul>
               </div>
